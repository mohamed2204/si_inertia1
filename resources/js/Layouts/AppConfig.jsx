...
const AppConfig = (props) => {
    ...
    const _changeTheme = (theme, colorScheme) => {
        // alert("Theme to be changed." + theme + colorScheme);
            ...
            >
                {!props.simple && (
                    <>
                        ...
                        <h5>Menu Type</h5>
                        <div className="flex">
                            <div className="flex-1 field-radiobutton">
                                <RadioButton
                                    name="menuMode"
                                    value={"static"}
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("lara-light-teal", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("lara-dark-blue", "dark")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("lara-dark-teal", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid">
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("md-light-indigo", "light")
                            }
                        >
                            <img
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("md-dark-indigo", "dark")
                            }
                        >
                            <img
                ...
                <div className="grid">
                    ...
                    <div className="col-3">
                        <button
                            className="p-link w-2rem h-2rem"
                            onClick={() =>
                                _changeTheme("mdc-dark-indigo", "dark")
                            }
                        >
                            <img
                                src="/layout/images/themes/md-dark-indigo.svg"
